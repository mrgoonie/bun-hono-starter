...
export default async function createNewUser(props: ICreateNewUserByAccount | ICreateNewUserByPassword) {
	...
	try {
		...
		throw new Error(`Create New User failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
	}
}
